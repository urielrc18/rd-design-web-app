...
<nav class="navbar" role="navigation" aria-label="main navigation" style="background-color: #ED5A5A;">
    ...
    <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                <a class="navbar-link">Emision Proformas y Guias</a>
                <div class="navbar-dropdown">
                    <a href="index.php?vista=product_list" class="navbar-item">Lista</a>
                    <a href="index.php?vista=product_category" class="navbar-item">Por categoría</a>
                    <a href="index.php?vista=product_search" class="navbar-item">Buscar</a>
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                <a class="navbar-link">Movimientos Capital</a>
                <div class="navbar-dropdown">
                    <a href="index.php?vista=product_new" class="navbar-item">Ingresos</a>
                </div>
            </div>
